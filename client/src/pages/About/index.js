          ...
          <div className="d-flex flex-row flex-wrap justify-content-center">
            ...
            <div className = "card about-paragraph p-3 m-2 align-self-start">
                ...
                <p>We used a combination of React, various react packages
                  and Bootstrap for our front-end. </p>
                  <code>Back-end</code>
                  <p>For our back-end we used Node.js and Express.js
            ...
            <div className = "card about-paragraph p-3 m-2 align-self-start">
              <h3>Creators</h3>
                ...
                <ul>
                  <li><a href="https://github.com/phyeony">Hyeonyoung Park</a></li>
                  <li><a href="https://github.com/cxtruong70">Calvin Truong</a></li>
                  <li><a href="https://github.com/zwemsoe">Zwe Min Soe</a></li>
                  <li><a href="https://github.com/ACimensel">Artun Cimensel</a></li>
                </ul>
            </div>
          </div>
        </div>
