...
const EditPost = (props) => {
    ...
    // Validate the post
    const validatePost = () => {
        if(title == props.post.title && tags == props.post.tags 
        && description == props.post.content && location == props.post.location) {
            ...
            >
                <div>
                    ...
                    <form onSubmit={handleEdit}>
                        ...
                        <div className="mb-3">
                            <h6>Tags</h6>
                            <Dropdown placeholder="Select tags" value = {tags}
                        ...
                        <div className = "mb-3">
                            <h6>Location</h6>
                            <SearchInputLocation location={props.post.location} setLocation={setLocation} />
                        </div>
